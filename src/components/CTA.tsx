...
export default function CTA() {
  return (
    <div className="w-full flex items-center justify-center p-4 md:p-8 bg-[#f0f0f0]">
      <section className="relative w-full max-w-[1720px] min-h-[500px] md:min-h-[620px] rounded-[1.5rem] md:rounded-[3rem] overflow-hidden flex flex-col items-center justify-center group py-16 md:py-20 px-6 md:px-12">
