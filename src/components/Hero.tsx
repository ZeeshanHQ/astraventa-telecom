      ...
      <section className="relative w-full max-w-[1536px] h-full rounded-[1.5rem] md:rounded-[3rem] overflow-hidden flex flex-col items-center group">
        ...
        >
          ...
          >
            ...
            <div className="flex items-center gap-2.5 border border-white/20 bg-white/8 backdrop-blur-sm px-4 py-1.5 mx-2 rounded-sm">
              {/* Signal dot */}
              <span className="relative flex h-1.5 w-1.5">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-cyan-400 opacity-75"></span>
                <span className="relative inline-flex rounded-full h-1.5 w-1.5 bg-cyan-400"></span>
              </span>
              <span className="text-[10px] uppercase tracking-[0.22em] font-bold text-white/80 font-mono whitespace-nowrap">Astraventa Telecom Infrastructure</span>
              {/* Right micro arrow */}
          ...
          <motion.h1 
            variants={itemVariants}
            className="text-5xl md:text-8xl font-black tracking-tight mb-6 select-none leading-none text-white drop-shadow-lg"
          >
          ...
          <motion.p 
            variants={itemVariants}
            className="text-white/95 text-lg md:text-xl font-normal leading-relaxed max-w-[700px] drop-shadow-md"
          >
