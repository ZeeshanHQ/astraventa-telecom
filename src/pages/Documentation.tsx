    ...
    <div className="w-full min-h-screen bg-[#f0f0f0] px-4 md:px-8 py-12 md:py-20">
      <div className="max-w-[960px] mx-auto">
        ...
        <div className="mb-14">
          ...
          <h1 className="text-4xl md:text-6xl font-black text-black tracking-tight leading-none mb-4">Trunk & API Specifications</h1>
        ...
        <div className="space-y-16 text-sm text-black/70 leading-relaxed font-medium">
          ...
          <section className="bg-white rounded-[1.5rem] md:rounded-[2rem] p-6 md:p-8 border border-black/5">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-xl font-black text-black tracking-tight">1. SIP Connection Parameters</h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 font-mono text-xs">
              <div className="bg-[#f0f0f0] p-4 rounded-xl space-y-2 border border-black/5">
          ...
          <section className="bg-white rounded-[1.5rem] md:rounded-[2rem] p-6 md:p-8 border border-black/5">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-xl font-black text-black tracking-tight">2. Dynamic Caller ID Rotation</h2>
            </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="bg-[#f0f0f0] p-3 rounded-lg font-mono text-xs text-black border border-black/5">
              ...
              <div>
                ...
                <pre className="bg-[#f0f0f0] p-4 rounded-xl font-mono text-xs text-black border border-black/5 overflow-x-auto">
{`{
  "trunk_id": "trk_01h8x9",
  ...
  "ttl_seconds": 3600
          ...
          <section className="bg-white rounded-[1.5rem] md:rounded-[2rem] p-6 md:p-8 border border-black/5">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-xl font-black text-black tracking-tight">3. Attestation & Whitelisting</h2>
            </div>
